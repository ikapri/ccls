...
SUBMIT_URL = 'http://www.codechef.com/%ssubmit/%s'
LOGOUT_URL = 'http://www.codechef.com/logout'
SUBMISSION_STATUS_URL = 'http://www.codechef.com/get_submission_status/%s'

headers = {
		'User-Agent':'Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.95 Safari/537.36'		
		}

LANG_CODES = {'python2.7':'4'}		